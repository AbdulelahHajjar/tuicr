...
No blocking watch or cursor yet. TUI side (2026-09-06): the Local follow tick re-fetches threads
in place when the store changes, so agent replies appear without `:e`.
